...
/* ---------------------------------------------------------------------------- //? Objects and Arrays setup for us to store, retrieve, and manipulate the teams and start time data that we've scrapped for game scheduling. --------------------------------------------------------------------------- */
...
//? Regex to match any time found in the table data that we scrapped. And .match returns an array of results, so we can access it without any more work.
